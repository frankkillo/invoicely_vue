    ...
    <div class="page-invoice">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><router-link :to="{ name: 'Invoice', params: { id: $route.params.id } }" aria-current="true">{{ invoice.invoice_number }}</router-link></li>
            </ul>
        </nav>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            sendReminder () {
                axios
                    .get(`/api/v1/invoices/${this.invoice.id}/send-reminder/`)
                    .then(response => {
                        toast({
