    ...
    <div class="page-edit-client">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li><router-link :to="{name: 'Client', params: { id: $route.params.id } }">{{ client.name }}</router-link></li>
                <li class="is-active"><router-link :to="{ name: 'EditClient', params: { id: $route.params.id } }" aria-current="true">Edit</router-link></li>
            </ul>
        </nav>
