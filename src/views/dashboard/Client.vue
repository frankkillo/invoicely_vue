    ...
    <div class="page-client">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><router-link :to="{name: 'Client', params: { id: $route.params.id } }" aria-current="true">{{ client.name }}</router-link></li>
            </ul>
        </nav>
        <div class="columns is-multiline">
            <div class="column is-12">
                ...
                <router-link :to="{ name: 'EditClient', params: { id: $route.params.id } }" class="button is-light mt-4">Edit</router-link>
            </div>
